  ...
  return (
    <div className="flex flex-col gap-2 text-sm text-white sm:col-span-2">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <label
          htmlFor={id}
          className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-white/20 px-3 py-2 text-xs font-semibold hover:border-[var(--color-accent)] has-[:disabled]:cursor-wait has-[:disabled]:opacity-50"
        >
          <input
            id={id}
            type="file"
